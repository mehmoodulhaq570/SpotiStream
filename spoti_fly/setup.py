...
setup(
    name="spoti_fly",  # Name of the package
    version="0.1.0",  # Version of the package
    author="Mehmood Ul Haq",  # Your name as the author
    author_email="mehmoodulhaq1040.com",  # Your email
    ...
    url="https://github.com/mehmoodulhaq570/SpotiFly",  # URL to the project
    project_urls={
        "Documentation": "https://github.com/mehmoodulhaq570/SpotiFly#readme",
        "Source": "https://github.com/mehmoodulhaq570/SpotiFly",
        "Bug Tracker": "https://github.com/mehmoodulhaq570/SpotiFly/issues",
    },
    ...
    entry_points={  # Entry points to create command-line tools
        'console_scripts': [
            'spoti_fly=spoti_fly.main:main',  # Creates a CLI command 'spoti_fly'
        ],
    },
